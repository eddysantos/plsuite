...
if (isset($_POST['login'])) {
  if (isset($_POST['userName']) && isset($_POST['password'])) {
    ...
    $loginQry = "SELECT *, u.pkIdUsers idUser , u.Nombre , u.Apellido , u.NombreUsuario , u.TipoUsuario , u.Status , u.NombreUsuario , up.invoice_control_save ic_save FROM old_users u LEFT JOIN users_permisos up ON u.pkIdUsers = up.fkid_user WHERE NombreUsuario = ? AND Contrasena = ?";
