  ...
  <body style="min-height:100%">
   ...
   <header>
     <div class="custom-header">
       ...
       <div><a class="ml-3 mr-5" role="button" href="dashboard.php"> <i class="fa fa-chevron-left"></i> </a> <?php echo $row['nameFirst'] . " " . $row['nameLast']?></div>
     </div>
   </header>
     ...
     <div class="container float-left driver-details-child right-side-border">
       ...
       <form>
         <div class="form-group row">
           ...
           <div class="col-4">
             <input class="form-control" type="text" name="dFirstName" id="dFirstName" value="<?php echo $row['nameFirst'] ?>">
           </div>
           <label class="col-2 col-form-label" for="dLastName">Last</label>
           <div class="col-4">
             <input class="form-control" type="text" name="dLastName" id="dLastName" value="<?php echo $row['nameLast'] ?>">
           </div>
         </div>
         <div class="form-group row">
           <label class="col-2 col-form-label" for="dPhone">Phone</label>
           <div class="col-10">
             <input class="form-control" type="text" name="dPhone" id="dPhone" value="<?php echo $row['phoneNumber'] ?>">
           </div>
         </div>
         <div class="form-group row">
           <label class="col-2 col-form-label" for="dEmail">E-Mail</label>
           <div class="col-10">
             <input class="form-control" type="text" name="dEmail" id="dEmail" value="<?php echo $row['email'] ?>">
           </div>
         </div>
         <div class="form-group row">
           ...
           <div class="col-4">
             <select class="form-control" name="dIsDriver" id="dIsDriver">
               <option value="Yes" <?php echo $row['isDriver'] == "Yes" ? "Selected" : ""?> >Yes</option>
               <option value="No" <?php echo $row['isDriver'] == "No" ? "Selected" : ""?> >No</option>
             </select>
           </div>
           <label class="col-2 col-form-label" for="dIsOwner">Owner?</label>
           <div class="col-4">
             <select class="form-control" name="dIsOwner" id="dIsOwner">
               <option value="Yes" <?php echo $row['isOwner'] == "Yes" ? "Selected" : ""?> >Yes</option>
               <option value="No" <?php echo $row['isOwner'] == "No" ? "Selected" : ""?> >No</option>
             </select>
           </div>
         </div>
         <input type="text" id="dIdDriver" name="dIdDriver" value="<?php echo $row['pkid_driver'] ?>" hidden>
       </form>
     </div>
