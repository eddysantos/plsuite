...
<ul class="nav nav-pills mb-3" id="dash-select-division" role="tablist">
  <li class="nav-item">
...
<div class="tab-content" id="dash-tab-content">
  <div class="tab-pane fade show active" id="pane-div-4" role="tabpanel" aria-labelledby="div4">
    <div class="border p-2 mb-2">
      ...
      <div class="" id="tms-summary-chart">
    ...
    <div class="border p-2 mb-2">
      ...
      <div class="" id="rpm-summary-chart">
        <div class="text-center p-4 bg-light">
          <h2>Loading <i class="fas fa-circle-notch fa-spin ml-"></i></h2>
        </div>
      </div>
    </div>
    <div class="border p-2 mb-2">
  ...
  <div class="tab-pane fade" id="pane-div-3" role="tabpanel" aria-labelledby="div-3">
    <div class="border p-2 mb-2">
      <div class="">
      ...
      <div class="d-flex justify-content-between">
        <form class="form-inline " onsubmit="return false;">
          Select date range: <input type="text" class="date-selector ml-1 mr-1 form-control form-control-sm text-center" id="is_chart_date_from" name="" value="<?php echo $sunday_5weeks?>">
          - <input type="text" class="date-selector ml-1 mr-1 form-control text-center form-control-sm" id="is_chart_date_to" name="" value="<?php echo $today?>">
          And cycle:
          <select class="form-control form-control-sm ml-1 mr-5" id="is_chart_period" name="">
            <option value="0">Daily</option>
            <option value="1" selected>Weekly</option>
            <option value="2">Monthly</option>
          </select>
        ...
        <div class="">
          ...
          <button type="button" class="btn btn-outline-success btn-sm" id="load_invoice_summary_chart" name="button">Load</button>
          <button type="button" class="btn btn-outline-secondary btn-sm reset-chart" target="is_chart" name="button">Reset</button>
        </div>
      </div>
      <div class="" id="invoice-summary-chart" style="display: none"></div>
    </div>

    <div class="border p-2 mb-2">
      <div class="">
        <h6>Collected Payment Summary</h6>
      </div>
      <div class="d-flex justify-content-between">
        <form class="form-inline " onsubmit="return false;">
          Select date range: <input type="text" class="date-selector ml-1 mr-1 form-control form-control-sm text-center" id="cs_chart_date_from" name="" value="<?php echo $sunday_5weeks?>">
          - <input type="text" class="date-selector ml-1 mr-1 form-control text-center form-control-sm" id="cs_chart_date_to" name="" value="<?php echo $today?>">
          And cycle:
          <select class="form-control form-control-sm ml-1 mr-5" id="cs_chart_period" name="">
            <option value="0">Daily</option>
            <option value="1" selected>Weekly</option>
            <option value="2">Monthly</option>
          </select>
        ...
        <div class="">
          <button type="button" class="btn btn-outline-success btn-sm" id="load_collected_summary_chart" name="button">Load</button>
          <button type="button" class="btn btn-outline-secondary btn-sm reset-chart" target="cs_chart" name="button">Reset</button>
        </div>
      </div>
      <div class="" id="collected-summary-chart" style="display: none"></div>
    </div>
  </div>
</div>
