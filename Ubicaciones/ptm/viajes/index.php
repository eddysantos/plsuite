...
<div class="container-fluid align-items-right d-flex justify-content-between align-content-center mb-3 position-sticky" style="margin-top: 65px">
  <div class="">
    <ul class="nav nav-pills" id="trip-filter" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" id="trips-tab" data-toggle="tab" href="#trips-pane" role="tab" aria-controls="trips" aria-selected="true">Viajes</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="transfers-tab" data-toggle="tab" href="#transfers-pane" role="tab" aria-controls="transfers">Cruces</a>
      </li>
    </ul>
  </div>
  <div class="float-right">
    <button class="btn btn-outline-success" type="button" data-toggle="modal" data-focus="false" data-target="#addTripModal" name="button">Agregar Nuevo</button>
  </div>
</div>
