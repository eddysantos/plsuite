...
/*
function stateDistances($lat1, $lat2, $long1, $long2)
{

    $origin = $lat1 . "," . $long1;
    $destination = $lat2 . "," . $long2;
    $apiKey = "AIzaSyB8KEktfGXe4z-nByf6_HG3QGsyXXnLBrA";
...
stateDistances($lati1, $lati2, $longi1, $longi2);
*/
 ?>
...
directionsRequest.origin = window.opener.origen;
directionsRequest.destination = window.opener.destino;
...
function compileMilesReciever(data){
    if(data===null){
        ...
        if(compileMilesIndex == orderedLatLngs.length){
            ...
            window.opener.addRouteDetails(stateMiles, routeId);
            return;
        }else{
