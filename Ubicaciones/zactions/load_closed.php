...
$query = "SELECT pk_idlinehaul linehaulid, linehaul_status status, fk_idtrip trip , fk_tripyear tyear , pk_linehaul_number linehaul , origin_city ocity , origin_state ostate , destination_city dcity , destination_state dstate FROM ct_trip_linehaul WHERE linehaul_status = 'Closed' AND fk_idtrip <> ''";
