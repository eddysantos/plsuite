...
error_log(json_encode($system_callback));


 ?>
<div class="container-fluid align-items-right justify-content-between d-flex mb-3 position-sticky" style="margin-top: 65px">
  ...
  <form class="form-inline m-0" method="GET">
    ...
    <input type="date" class="form-control mr-2" name="cTripsFrom" id="cTripsFrom" value="<?php echo $data['from']?>">
    <label for="cTripsTo" class="mr-2">To</label>
    <input type="date" class="form-control mr-5" name="cTripsTo" id="cTripsTo" value="<?php echo $data['to']?>">
