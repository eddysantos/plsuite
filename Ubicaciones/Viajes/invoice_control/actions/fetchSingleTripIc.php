...
$sc['data']['payment_date'] = parseDate($sc['data']['payment_date'], 2);
$sc['data']['invoice_date'] = parseDate($sc['data']['invoice_date'], 2);
...
$sc['data']['payment_date'] = $sc['data']['payment_date']['date'];
// $sc['data']['payment_due_hour'] = $sc['data']['payment_due']['time']['hour'];
// $sc['data']['payment_due_minute'] = $sc['data']['payment_due']['time']['minute'];
$sc['data']['invoice_date'] = $sc['data']['invoice_date']['date'];
// $sc['data']['invoice_date_hour'] = $sc['data']['invoice_date']['time']['hour'];
// $sc['data']['invoice_date_minute'] = $sc['data']['invoice_date']['time']['minute'];
