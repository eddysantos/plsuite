...
foreach ($linehauls as $lh) {
  ...
  $system_callback['data'] .= "<tr role='button' db-id='$lh[pk_idlinehaul]' tripnumber='$lh[trip_number]' lh-number='$lh[lh_number]' tripyear='$lh[trip_year]'>
  <td>
  ...
  <div class=''>$lh[destination_city] $lh[destination_state], $lh[destination_zip]</div></td>
  <td class=''>Rate: $" . number_format($lh['trip_rate'] , 2) . "</td>
  <td>
