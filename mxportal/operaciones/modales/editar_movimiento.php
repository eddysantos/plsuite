<div class="modal fade" id="editarMovimiento_modal" tabindex="-1" role="dialog" aria-labelledby="editarMovimiento" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="nb-id">Editar Registro <span class="cp_number"><span></h5>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-primary" id="saveEditModal_btn" name="button">Guardar Cambios</button>
      </div>
    </div>
  </div>
</div>
