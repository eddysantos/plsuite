      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            <select class="custom-select" name="" id="viaje_cliente">
              <option value="">Selecciona un cliente</option>
              <?php foreach ($clientes['list'] as $cliente): ?>
                <option value="<?php echo $cliente['pk_mx_cliente'] ?>"><?php echo $cliente['client_name'] ?></option>
              <?php endforeach; ?>
            </select>
            <div class="popup-list mt-0" style="display:none; z-index: 9999"></div>
          </div>
          <div class="form-inline justify-content-between">
            <select class="custom-select flex-grow-1 mr-1" name="" id="viaje_operador">
            ...
            <select class="custom-select flex-grow-1 ml-1" name="" id="viaje_tractor">
