...
$system_callback = [];
$update_movement = "UPDATE mx_carta_porte SET date_start = ?, date_end = ?, odometer_start = ?, odometer_end = ? WHERE pk_carta_porte = ?";
...
$update_movement->bind_param('sssss', $date_start, $date_end, $odometer_start, $odometer_end, $pk_carta_porte);
if (!($update_movement)) {
  $system_callback['code'] = "500";
  $system_callback['query'] = $query;
