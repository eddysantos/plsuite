  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-outline-primary executeReport" report-location="" name="button">Correr</button>
        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal" name="button">Cancelar</button>
      </div>
    </div>
  </div>
</div>
